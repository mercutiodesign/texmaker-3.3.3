...
void PdfViewer::openFile(QString fn,QString ec,QString pc) {
    ...
    if (doc!=0) {
        ...
        if (scrollArea->horizontalScrollBar()->isVisible())  {
            QTimer::singleShot( 500,this, SLOT(jumptoHpos()) );
        }
...
//out << "';\n";
    ...
    bool done=false;
    if (spell_lang=="fr") {
        out << "<OPTION selected>fr</OPTION>\n";
        done=true;
    } else out << "<OPTION>fr</OPTION>\n";
    if (spell_lang=="de") {
        out << "<OPTION selected>de</OPTION>\n";
        done=true;
    } else out << "<OPTION>de</OPTION>\n";
    if (spell_lang=="nl") {
        out << "<OPTION selected>nl</OPTION>\n";
        done=true;
    } else out << "<OPTION>nl</OPTION>\n";
    if (spell_lang=="pl") {
        out << "<OPTION selected>pl</OPTION>\n";
        done=true;
    } else out << "<OPTION>pl</OPTION>\n";
    if (spell_lang=="pt") {
        out << "<OPTION selected>pt</OPTION>\n";
        done=true;
    } else out << "<OPTION>pt</OPTION>\n";
    if (spell_lang=="ru") {
        out << "<OPTION selected>ru</OPTION>\n";
        done=true;
    } else out << "<OPTION>ru</OPTION>\n";
    if (spell_lang=="it") {
        out << "<OPTION selected>it</OPTION>\n";
        done=true;
    } else out << "<OPTION>it</OPTION>\n";
    if (spell_lang=="es") {
        out << "<OPTION selected>es</OPTION>\n";
        done=true;
